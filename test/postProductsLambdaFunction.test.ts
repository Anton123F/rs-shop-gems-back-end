import {handler as postProductsHandler} from '../lambda_function_handlers/postProductsLambdaHandler';
...
describe('Tests getProductsLambdaHandler', () => {
  afterEach(() => {
    ...
    mockBodyRequest.title = 'Example test title';
    mockBodyRequest.description = 'test description';
  });
